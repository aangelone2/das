...
def test_simple():
    ...
    assert np.array_equal(
        ds1[0],
        np.array([0.79257095, 0.79830817, 0.94791775, 0.06518289]),
    )
    assert np.array_equal(
        ds1[52],
        np.array([0.51715544, 0.96024379, 0.6738459, 0.80586979]),
    )
    assert np.array_equal(
        ds1[-1],
        np.array([0.61788947, 0.63002014, 0.93538286, 0.45439481]),
    )
...
def test_nbins():
    ...
    assert np.array_equal(
        ds1[0],
        np.array([0.27288035, 0.62491234, 0.50501386, 0.35869342]),
    )
    assert np.array_equal(
        ds1[13],
        np.array([0.59794363, 0.58962945, 0.65848451, 0.43271424]),
    )
    assert np.array_equal(
        ds1[-1],
        np.array([0.61788947, 0.63002014, 0.93538286, 0.45439481]),
    ...
    assert np.array_equal(
        ds2[0],
        np.array([0.71912613, 0.3420949, 0.99502956, 0.50921441]),
    )
    assert np.array_equal(
        ds2[5],
        np.array([0.32173851, 0.59395812, 0.03953717, 0.68371832]),
    )
    assert np.array_equal(
        ds2[-1],
        np.array([0.61788947, 0.63002014, 0.93538286, 0.45439481]),
...
def test_short():
    ...
    ds = parse_ds("tests/data/dr-03-short.dat", None, colnum_test=True)
